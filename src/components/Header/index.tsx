...
export const Header = () => {
    ...
    return (
                            ...
                            <Button
                                ...
                                icon={
                                    <svg
                                        ...
                                        width="20px"
                                        height="20px"
                                        viewBox="796 632.07 200 200"
                                        enableBackground="new 796 632.07 200 200"
                                    >
                                        <g>
                                            <path
                                                d="M909.152,813.736c-5.217,0-9.46-4.242-9.46-9.457c0-5.218,4.243-9.46,9.46-9.46h61.998c3.271,0,5.933-2.659,5.933-5.929
		...
		c13.703,0,24.85,11.146,24.85,24.846V788.89c0,13.699-11.146,24.846-24.85,24.846H909.152z"
                                            />
                                            <path
                                                d="M870.573,793.234c-2.526,0-4.902-0.985-6.688-2.771c-1.787-1.787-2.771-4.161-2.771-6.688s0.984-4.901,2.771-6.688
